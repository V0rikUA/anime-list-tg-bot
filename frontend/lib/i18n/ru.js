export const ru = {
  ...
  dashboard: {
    ...
    refresh: 'Обновить',
    search: 'Поиск',
    searchHint: 'Запрос отправляется только по части после первого пробела. Пример: "/s Наруто".',
    searchPlaceholder: 'Например: "/s Наруто"...',
    searchWaitSpace: 'Поставь пробел и введи название, чтобы начать поиск.',
    searchLoading: 'Ищу...',
