export const uk = {
  ...
  dashboard: {
    ...
    refresh: 'Оновити',
    search: 'Пошук',
    searchHint: 'Запит відправляється тільки по частині після першого пробілу. Приклад: "/s Наруто".',
    searchPlaceholder: 'Наприклад: "/s Наруто"...',
    searchWaitSpace: 'Постав пробіл і введи назву, щоб почати пошук.',
    searchLoading: 'Шукаю...',
