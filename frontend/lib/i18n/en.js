export const en = {
  ...
  dashboard: {
    ...
    refresh: 'Refresh',
    search: 'Search',
    searchHint: 'Type anime title directly. Command style also works, e.g. "/s Naruto".',
    searchPlaceholder: 'Type "Naruto" or "/s Naruto"...',
    searchWaitSpace: '',
    searchLoading: 'Searching...',
    searchSessionExpired: 'Session expired. Reopen the Mini App from the bot.',
    ...
    continueEmpty: 'No started titles yet',
    continueEpisode: 'Episode: {episode}',
    continueSource: 'Source: {source}',
