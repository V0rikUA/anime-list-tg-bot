export const en = {
  ...
  dashboard: {
    ...
    refresh: 'Refresh',
    search: 'Search',
    searchHint: 'Type anything, then space, then the title. Example: "/s Naruto".',
    searchPlaceholder: 'Type "/s Naruto"...',
    searchWaitSpace: 'Add a space, then the title to start searching.',
